...
for i in range(len(cat_type_list)):
	...
	X_train, X_test, y_train, y_test = train_test_split(vars_dist, class_type, test_size = test_size_percentage)
	...
	splot  = plot_data(lda, X_test, y_test, class_type_pred, cat_type_list[i][0][3], cat_type_list[i][0][4], cat_type_list[i][1][4], fig_index=i+1)
	#splot, All_tp0_category_classifications[i,valid_disc0_indices], All_tp1_category_classifications[i,valid_disc1_indices]  = plot_data(lda, X_test, y_test, class_type_pred, cat_type_list[i][0][3], cat_type_list[i][0][4], cat_type_list[i][1][4], fig_index=i+1)
...
#set_trace()
outname = 'ttJetsM1000_THadPt_vs_%s_%s_%s_Comparison_split' % (discname, cat_type_list[0][0][3], cat_type_list[1][0][3])
